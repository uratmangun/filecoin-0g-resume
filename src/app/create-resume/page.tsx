...
export default function CreateResumePage() {
  ...
  const [resumeBasics, setResumeBasics] =
    useState<ResumeBasics>(createEmptyBasics());
  ...
  useEffect(() => {
    ...
    const loadResumeFromStorage = async () => {
      try {
        ...
        setLoadErrorMessage(
          "We could not restore your saved resume in this browser.",
        );
      }
    };
  ...
  const handleBasicChange = (
    field: keyof typeof resumeBasics,
    value: string,
  ) => {
  ...
  const handleProjectEntryChange = (
    index: number,
  ...
  const handleAchievementEntryChange = (
    index: number,
  ...
  const handleSaveResume = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setSaveStatus("error");
      setSaveErrorMessage(
        "We could not save your resume locally. Please try again.",
      );
    } finally {
      setIsSaving(false);
    }
  ...
  const handleUpdateSelectedResume = async () => {
    ...
    try {
      ...
      setSaveStatus("error");
      setSaveErrorMessage(
        "We could not update your saved resume. Please try again.",
      );
    } finally {
      setIsUpdating(false);
    }
      ...
      <div className="max-w-6xl px-6 md:px-8 pt-6 md:pt-8 pb-16 md:pb-24 mx-auto text-center">
        <section className="mt-12 text-left">
          <div className="rounded-2xl bg-white/90 dark:bg-slate-900/95 border border-teal-100/50 dark:border-teal-900/60 shadow-xl shadow-teal-900/10 px-6 py-8 md:px-8 md:py-10">
            <h2 className="text-3xl font-semibold text-teal-900 dark:text-teal-100">
              Create your resume
            </h2>
            <p className="mt-3 text-base text-slate-600 dark:text-slate-300">
              Fill out the essentials below to craft a tailored resume that
              pairs perfectly with our AI analysis.
            </p>
            <form
            ...
            >
              <div className="grid gap-2 md:grid-cols-2 md:gap-6">
                <div className="grid gap-2">
                  ...
                  <input
                    ...
                    onChange={(event) =>
                      handleBasicChange("name", event.target.value)
                    }
                  />
                </div>
                <div className="grid gap-2">
                  ...
                  <input
                    ...
                    onChange={(event) =>
                      handleBasicChange("email", event.target.value)
                    }
                  />
                </div>
                <div className="grid gap-2 md:col-span-2">
                  ...
                  <input
                    ...
                    onChange={(event) =>
                      handleBasicChange("github", event.target.value)
                    }
                  />
                </div>
              </div>
                  ...
                  {workHistoryEntries.map((entry, index) => (
                    ...
                    >
                      <div className="grid gap-3 sm:grid-cols-2 sm:gap-4">
                        <div className="grid gap-2">
                          <label
                            htmlFor={"resume-work-company-" + index}
                            className="text-sm font-medium text-teal-900 dark:text-teal-100"
                          >
                            Company name
                          </label>
                        ...
                        <div className="grid gap-2">
                          <label
                            htmlFor={"resume-work-dates-" + index}
                            className="text-sm font-medium text-teal-900 dark:text-teal-100"
                          >
                            Date range
                          </label>
                      ...
                      <div className="grid gap-2">
                        <label
                          htmlFor={"resume-work-description-" + index}
                          className="text-sm font-medium text-teal-900 dark:text-teal-100"
                        >
                          What you did there
                        </label>
                      ...
                      {workHistoryEntries.length > 1 ? (
                        ...
                        <span>
                          Printable view uses your last saved resume data.
                        </span>
                      )}
                    </div>
                  ))}
              ...
              <div className="grid gap-4">
                <div className="flex flex-wrap items-center justify-between gap-2">
                  <label
                    htmlFor="resume-project-title-0"
                    className="text-sm font-medium text-teal-900 dark:text-teal-100"
                  >
                    Projects
                  </label>
                  ...
                  {projectEntries.map((entry, index) => (
                    ...
                    >
                      <div className="grid gap-3 sm:grid-cols-2 sm:gap-4">
                        <div className="grid gap-2">
                          <label
                            htmlFor={"resume-project-title-" + index}
                            className="text-sm font-medium text-teal-900 dark:text-teal-100"
                          >
                            Project title
                          </label>
                        ...
                        <div className="grid gap-2">
                          <label
                            htmlFor={"resume-project-link-" + index}
                            className="text-sm font-medium text-teal-900 dark:text-teal-100"
                          >
                            Project link
                          </label>
                      ...
                      <div className="grid gap-2">
                        <label
                          htmlFor={"resume-project-description-" + index}
                          className="text-sm font-medium text-teal-900 dark:text-teal-100"
                        >
                          Project description
                        </label>
              ...
              <div className="grid gap-4">
                <div className="flex flex-wrap items-center justify-between gap-2">
                  <label
                    htmlFor="resume-achievement-title-0"
                    className="text-sm font-medium text-teal-900 dark:text-teal-100"
                  >
                    Achievements
                  </label>
                  ...
                  {achievementEntries.map((entry, index) => (
                    ...
                    >
                      <div className="grid gap-3 sm:grid-cols-2 sm:gap-4">
                        <div className="grid gap-2">
                          <label
                            htmlFor={"resume-achievement-title-" + index}
                            className="text-sm font-medium text-teal-900 dark:text-teal-100"
                          >
                            Award title
                          </label>
                        ...
                        <div className="grid gap-2">
                          <label
                            htmlFor={"resume-achievement-link-" + index}
                            className="text-sm font-medium text-teal-900 dark:text-teal-100"
                          >
                            Award link
                          </label>
                      ...
                      <div className="grid gap-2">
                        <label
                          htmlFor={"resume-achievement-description-" + index}
                          className="text-sm font-medium text-teal-900 dark:text-teal-100"
                        >
                          Award description
                        </label>
              ...
              <div className="flex flex-col items-start gap-3 sm:items-end">
                ...
                <button
                  ...
                  disabled={
                    isUpdating ||
                    !selectedResumeId ||
                    selectedResumeId === SAMPLE_RESUME_ID
                  }
                >
              ...
              <div className="mt-10">
                ...
                <p className="mt-2 text-sm text-slate-600 dark:text-slate-300">
                  Select a saved resume to load it into the editor. You can
                  update the selected resume with the button above.
                </p>
                ...
                <div className="mt-4 grid gap-3">
                  {isListLoading ? (
                    ...
                    <div className="text-sm text-slate-500">
                      No saved resumes yet. Press "Save resume to this browser"
                      to create one.
                    </div>
                  ) : (
                            ...
                            <div>
                              <div className="font-medium text-teal-900 dark:text-teal-100">
                                ...
                                {isSampleResumeId(item.id) ? (
                                  <span className="ml-2 inline-flex items-center rounded-full border border-teal-300/70 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-teal-700 dark:border-teal-800 dark:text-teal-200">
                                    Sample
                                  </span>
                                ) : null}
                              </div>
            ...
            <div className="mt-12 border-t border-teal-100/60 dark:border-teal-900/50 pt-10">
              ...
              <p className="mt-2 text-sm text-slate-600 dark:text-slate-300">
                See how your resume is shaping up as you make edits.
              </p>
              <div className="mt-8 rounded-xl border border-teal-100/60 dark:border-teal-900/60 bg-white/80 dark:bg-slate-950/30 p-6 shadow-sm">
                {previewHasContent ? (
                  <div className="space-y-8 text-left text-slate-800 dark:text-slate-100">
                    <header className="space-y-2">
                      <h4 className="text-xl font-semibold text-teal-900 dark:text-teal-100">
                        {resumeBasics.name ||
                          "Add your name to personalize this preview"}
                      </h4>
                    ...
                    <section className="space-y-3">
                      <h5 className="text-sm font-semibold uppercase tracking-wide text-teal-700 dark:text-teal-300">
                        Work Experience
                      </h5>
                      {normalizedWorkEntries.length > 0 ? (
                          ...
                          {normalizedWorkEntries.map((entry, index) => (
                            ...
                            >
                              ...
                              <p className="text-sm leading-relaxed text-slate-600 dark:text-slate-300">
                                {entry.description ||
                                  "Summarize your impact, responsibilities, and measurable results..."}
                              </p>
                            </div>
                          ))}
                        </div>
                        ...
                        <p className="text-sm text-slate-500 dark:text-slate-400">
                          Add roles to showcase your experience.
                        </p>
                      )}
                    </section>
                    ...
                    <section className="space-y-3">
                      ...
                      {normalizedProjectEntries.length > 0 ? (
                        <div className="space-y-4">
                          {normalizedProjectEntries.map((entry, index) => (
                            ...
                            >
                              ...
                              <p className="text-sm leading-relaxed text-slate-600 dark:text-slate-300">
                                {entry.description ||
                                  "Outline your role, stack, and measurable results..."}
                              </p>
                            </div>
                          ))}
                        </div>
                        ...
                        <p className="text-sm text-slate-500 dark:text-slate-400">
                          Highlight key projects to display your skills.
                        </p>
                      )}
                    </section>
                    ...
                    <section className="space-y-3">
                      ...
                      {normalizedAchievementEntries.length > 0 ? (
                        <div className="space-y-4">
                          {normalizedAchievementEntries.map((entry, index) => (
                            ...
                            >
                              ...
                              <p className="text-sm leading-relaxed text-slate-600 dark:text-slate-300">
                                {entry.description ||
                                  "Describe the recognition and why it matters."}
                              </p>
                            </div>
                          ))}
                        </div>
                        ...
                        <p className="text-sm text-slate-500 dark:text-slate-400">
                          Add awards or certifications to round out your
                          achievements.
                        </p>
                      )}
                    </section>
                  ...
                  <div className="rounded-lg border border-dashed border-teal-200/70 bg-white/60 p-6 text-sm text-slate-500 dark:border-teal-900/60 dark:bg-slate-950/20 dark:text-slate-400">
                    Start filling in the resume fields to see a live preview
                    appear here.
                  </div>
                )}
              </div>
